...
$idss = $_GET['id'];
$results = Winners::where('win_num_id', $idss)
    ...
    foreach ($results as $winners) {
      ...
      array_push($lists, [
        ...
        'bet_id' => $winners->bet_id,
        'digit' => $winners->digit,
        'draw_id' => $winners->draw_id,
        'amount' => $winners->amount,
        'prize_amount' => $winners->prize_amount,
        'category' => $winners->category,
        'date_created' => $winners->date_created,
          ...
          <div class="col-12">
              <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <br /><br />
                      <a href="winning_numbers.php" class="btn btn-primary">Back</a>
