...
$trans = Transactions::where('type', 'Withdraw')
        ->where('status', 'sent')
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php
                            ...
                            ?>
                                        ...
                                        <td><?= $the['id'] ?></td>
                                        <td><?= $the['user_id'] ?></td>
                                        <td><?= $bolausers->getUserName($the['user_id']) ?></td>
                                        <td><?= $the['amount'] ?></td>
                                        <td><?= $the['account_name'] ?></td>
                                        <td><?= $the['account_number'] ?></td>
                                        <td><?= $the['payment_method'] ?></td>
                                        <td><?= $the['status'] ?></td>
